...
setwd('C:\\Users\\Andjela\\Desktop\\Tehnologija 2015mm FILTERI')
...
write.xlsx(result, '../Doziranje2015.xlsx',row.names = FALSE, col.names = FALSE, sheetName = "Podaci")